...
class ViewUser extends StatefulWidget {
  ...
  ValueKey<int> key;
  var fil;
  ViewUser({this.changeView, required this.index, required this.key, this.fil});
  @override
...
class _ViewUserState extends State<ViewUser> {
  ...
  Widget _buildCard({required String data, icon}) {
    return Container(
  ...
  Widget _buildButton({required String data, tap}) {
    return ConstrainedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          elevation: 0,
          backgroundColor: Color(0xFFD46382),
            ...
            if (snapshot.hasData) {
              return Column(
                children: [
                  Container(
                    width: double.infinity,
                    height: (ResponsiveLayout.isDesktop(context)) ? 350 : 200,
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: (snapshot.data.docs[index].get('isActive'))
                              ? [
                  ...
                  Column(
                    children: [
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                _buildCard(
                                    data: snapshot.data.docs[index].get('city'),
                                ...
                                _buildCard(
                                    data: snapshot.data.docs[index].get('role'),
                      ...
                      _buildButton(
                          data: (snapshot.data.docs[index].get('isActive'))
                              ? 'Editar'
                              : 'Reactivar contacto',
                          tap: () {
                            (snapshot.data.docs[index].get('isActive'))
                      ...
                      _buildButton(
                          ...
                          tap: () {
                            (snapshot.data.docs[index].get('isActive'))
                                ? _alertDelete(snapshot.data.docs[index])
                                : null;
                          }),
                      SizedBox(
                        height: 15,
