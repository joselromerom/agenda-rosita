...
class _ViewProductsState extends State<ViewProducts> {
  ...
  var index;
  _ViewProductsState(
      {this.changeView, this.index, required this.inCustomerView});
  ...
  Future _showMyDialog(
      BuildContext context, String dialog, String titulo) async {
    return showDialog(
      context: context,
  ...
  Widget _buildCustomerCard(
      {required String title, required String data, icon}) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 20),
      child: Column(
    ...
    return ConstrainedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          elevation: 0,
          backgroundColor:
              (inCustomerView) ? Color(0xFF8063D4) : Color(0xFFD46382),
                                        ...
                                        tap: () {
                                          ...
                                          if (misCarts.length != 0) {
                                            ...
                                            if (exist == false) {
                                              ...
                                              _showMyDialog(
                                                  context,
                                                  'Ya tiene este producto en su carrito.',
                                                  'Error');
                                            }
                                          } else {
                                            misCarts.add(thisCart);
