...
class _ProductsRegisterState extends State<ProductsRegister> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildUrlField({required String url}) {
      return TextFormField(
    ...
    Widget _buildCategoryField({required String category}) {
      String selected = "";
    ...
    Widget _buildDescriptionField({required String description}) {
      return TextFormField(
        keyboardType: TextInputType.text,
    ...
    Widget _buildPriceField({required String price}) {
      return TextFormField(
    ...
    Widget _buildQuantityField({required String quantity}) {
      return TextFormField(
        keyboardType: TextInputType.number,
